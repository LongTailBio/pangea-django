...
READS_CLASSIFIED_NAMES = ('cap1::read_classification_proportions', 'json', 'Reads Classified')
COVID_FAST_DETECT_NAMES = ('cap2::experimental::covid19_fast_detect', 'report', 'Reads Classified')
